    ...
    <header className={`site-header ${scrolled ? 'site-header--scrolled' : ''}`}>
      <div className="site-header-inner">
        <a href="#top" className="site-logo" aria-label="Japan Technology home" onClick={handleNavClick}>
          ...
          <span className="site-logo-wordmark">JAPAN TECHNOLOGY <span className="site-logo-wordmark-accent">CO., LTD</span></span>
        </a>
        ...
        <nav className={`site-nav ${mobileOpen ? 'site-nav--open' : ''}`}>
          ...
          <a href="https://auctions.yahoo.co.jp/seller/27fYwvFBQ2uFVTZ4sZycReaNDQuwA" target="_blank" rel="noopener noreferrer" className="site-nav-cta" onClick={handleNavClick}>YAHOO SHOP <i className="ti ti-external-link" aria-hidden="true"></i></a>
        </nav>
      </div>
    </header>
  );
